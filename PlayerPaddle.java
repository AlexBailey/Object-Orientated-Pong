...
public class PlayerPaddle { //this declares a public class named PlayerPaddle
	...
	public PlayerPaddle(int x, int y) { //this declares the a method that is called PlayerPaddle and calls to integer X and Y it is using it for the x and Y location
...
} //this closes the entire PlayerPaddle class